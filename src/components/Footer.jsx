  ...
  return (
    <footer className=" py-8 absolute top-[2351px] p-6 sm:top-[3376px] md:top-[4530px] lg:top-[5104px]">
      <div className="container mx-auto flex justify-between md:flex-wrap">
        ...
        {/* Right Div */}
        <div className="flex space-x-16 w-[284px] h-40 sm:w-[450px] sm:h-60 md:w-[560px] md:h-72 md:ml-8 p-6 rounded-md bg-[#FBF8ED] sm:ml-4 lg:w-[939px] lg:h-[460px] lg:gap-10 lg:ml-10 justify-evenly">
          {/* About Section */}
          <div>
